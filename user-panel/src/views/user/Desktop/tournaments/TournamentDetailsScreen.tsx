...
import DesktopBracketTree from '@/views/user/Desktop/tournaments/_bracket/DesktopBracketTree';
...
function BracketTab({ tournament, matches }: { tournament: Tournament; matches: Match[] }) {
  return <DesktopBracketTree tournament={tournament} matches={matches} />;
}
